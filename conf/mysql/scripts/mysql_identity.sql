...
-- ======================================================================
-- WSO2 Identity Server 7.2.0 Database Schema
-- This schema includes both shared (registry) and identity-specific tables
-- ======================================================================


-- ======================================================================
-- SHARED DATABASE SCHEMA (Registry Tables)
-- ======================================================================
...
CREATE TABLE IF NOT EXISTS UM_RESOURCE_SHARING_POLICY (
            ...
            PRIMARY KEY (UM_ID),
            UNIQUE (UM_RESOURCE_TYPE, UM_RESOURCE_ID, UM_POLICY_HOLDING_ORG_ID),
...
-- ======================================================================
-- IDENTITY DATABASE SCHEMA (Identity-Specific Tables)
-- ======================================================================
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_TOKEN_BINDING (
            ...
            TENANT_ID INTEGER DEFAULT -1,
            UNIQUE (TOKEN_ID,TOKEN_BINDING_TYPE,TOKEN_BINDING_VALUE(400)),
            FOREIGN KEY (TOKEN_ID) REFERENCES IDN_OAUTH2_ACCESS_TOKEN(TOKEN_ID) ON DELETE CASCADE
)DEFAULT CHARACTER SET latin1 ENGINE INNODB;
...
CREATE TABLE IF NOT EXISTS IDN_SCIM_GROUP (
            ...
            UNIQUE(TENANT_ID, ROLE_NAME, ATTR_NAME(500), AUDIENCE_REF_ID),
            PRIMARY KEY (ID)
)DEFAULT CHARACTER SET latin1 ENGINE INNODB;
...
CREATE INDEX IDX_TK_VALUE_TYPE ON IDN_OAUTH2_TOKEN_BINDING (TOKEN_BINDING_VALUE(400), TOKEN_BINDING_TYPE);

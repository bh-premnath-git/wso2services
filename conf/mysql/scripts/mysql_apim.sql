...
CREATE TABLE IF NOT EXISTS IDN_SCIM_GROUP (
            ...
            UNIQUE(TENANT_ID, ROLE_NAME, ATTR_NAME(500)),
            PRIMARY KEY (ID)
)ENGINE INNODB;
...
CREATE TABLE IF NOT EXISTS AM_API_ENDPOINTS (
    ...
    PRIMARY KEY (API_UUID(100), ENDPOINT_UUID(100), ENDPOINT_NAME(100), REVISION_UUID(100), ORGANIZATION)
)ENGINE INNODB;
...
CREATE INDEX IDX_IAT_TI_CK ON IDN_INVALID_TOKENS (TOKEN_IDENTIFIER(500), CONSUMER_KEY);

...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN (
            ...
            FOREIGN KEY (CONSUMER_KEY_ID) REFERENCES IDN_OAUTH_CONSUMER_APPS(ID) ON DELETE CASCADE,
            CONSTRAINT CON_APP_KEY UNIQUE (CONSUMER_KEY_ID,AUTHZ_USER(100),TENANT_ID,USER_DOMAIN(50),USER_TYPE(25),TOKEN_SCOPE_HASH,
                                           TOKEN_STATE(25),TOKEN_STATE_ID(128),IDP_ID,TOKEN_BINDING_REF)
)ENGINE INNODB;
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_TOKEN_BINDING (
            ...
            TENANT_ID INTEGER DEFAULT -1,
            UNIQUE (TOKEN_ID,TOKEN_BINDING_TYPE,TOKEN_BINDING_VALUE(255)),
...
CREATE TABLE IF NOT EXISTS IDN_SCIM_GROUP (
            ...
            UNIQUE(TENANT_ID, ROLE_NAME, ATTR_NAME(191)),
            PRIMARY KEY (ID)
)ENGINE INNODB;
...
CREATE INDEX IDX_IDN_SCIM_GROUP_TI_RN_AN ON IDN_SCIM_GROUP (TENANT_ID, ROLE_NAME, ATTR_NAME(191));
...
CREATE INDEX IDX_TK_VALUE_TYPE ON IDN_OAUTH2_TOKEN_BINDING (TOKEN_BINDING_VALUE(255), TOKEN_BINDING_TYPE);
...
CREATE INDEX IDX_IAT_TI_CK ON IDN_INVALID_TOKENS (TOKEN_IDENTIFIER(191), CONSUMER_KEY);
